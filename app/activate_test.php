<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if ($test['activation_time']) {
            ...
            redirectToPageWithPost('examiner_dashboard.php', 'This test is already active.', 'alert-warning');
            exit();
        } else {
            ...
            require_once('inc/utils.php');
            redirectToPageWithPost('examiner_dashboard.php', 'Test was successfully activated.', 'alert-success');
            exit();
        }
    } else {
        require_once('inc/utils.php');
